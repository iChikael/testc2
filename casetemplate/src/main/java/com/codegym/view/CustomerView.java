...
public class CustomerView {
    ...
    private void addNewCustomerView() {
//        List<Customer> customers = customerService.getAllCustomers();
        ...
        System.out.println("Nhập tổng tiêu phí:");
        Double consumed = Double.parseDouble(scanner.nextLine());
        System.out.println("Nhập hạng khách hàng:");
        CustomerType customerType = CustomerType.parseToCustomerType(scanner.nextLine());

        customer.setPhone(phoneCustomer);
        customer.setAddress(address);
        customer.setName(name);
        customer.setCustomerType(customerType);
        customer.setConsumed(consumed);
